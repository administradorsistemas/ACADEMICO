...
{
    public partial class ACA_075_Historico_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        public string usuario { get; set; }
        public string empresa { get; set; }

        public ACA_075_Historico_Rpt()
        {
            InitializeComponent();
        }
        ...
        private void ACA_075_Historico_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            lst_rpt = bus_rpt.GetListHistorico(IdEmpresa, IdAnio, IdSede, IdNivel, IdJornada, IdCurso, IdParalelo, MostrarRetirados);
